...
namespace DatingApp.API.Controllers
{
    ...
    public class MessagesController : ControllerBase
    {
        ...
        {
            /* fix the messageToReturn senderKnownAs and senderPhotoUrl issue */
        ...
        [HttpPost("{id}")] /* normal delete user HttpDelete; however, this is just update. aka. mark delete status */
